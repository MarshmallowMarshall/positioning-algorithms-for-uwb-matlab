...
plot(mean(xCorrectedEKFObj(:,1)),mean(xCorrectedEKFObj(:,2)),'ro');

vrpn_pose= extract_uwbrange_yaml('..\exp_data\Optitrack_yaml\vrpn_pose_static3.yaml');
p_Vf= [mean(vrpn_pose(:,1)),mean(vrpn_pose(:,2)),mean(vrpn_pose(:,3))];
